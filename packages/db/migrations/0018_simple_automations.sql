...
ALTER TABLE "automation_executions" ADD CONSTRAINT "automation_executions_member_id_workspace_members_id_fk" FOREIGN KEY ("member_id") REFERENCES "public"."workspace_members"("id") ON DELETE set null ON UPDATE no action;--> statement-breakpoint
...
CREATE INDEX "automation_executions_activity_idx" ON "automation_executions" USING btree ("rule_id","conversation_id","activity_at","member_id");--> statement-breakpoint
...
CREATE UNIQUE INDEX "automation_rules_workspace_request_uq" ON "automation_rules" USING btree ("workspace_id","request_key");--> statement-breakpoint
