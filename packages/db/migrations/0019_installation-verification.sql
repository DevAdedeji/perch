...
CREATE INDEX "widget_installation_signals_workspace_recency_idx" ON "widget_installation_signals" USING btree ("workspace_id","last_seen_at");--> statement-breakpoint
CREATE INDEX "widget_installation_signals_workspace_first_seen_idx" ON "widget_installation_signals" USING btree ("workspace_id","first_seen_at");